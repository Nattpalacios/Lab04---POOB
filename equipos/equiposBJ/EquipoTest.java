...
public class EquipoTest{
   ...
   @Test
    public void deberiaLanzarExcepcionSiNoSePuedeCalcularElValorEstimado(){
        String [] nombres={"Pedro","Santiago","Marcos","Ospina","Juan"};
        Equipo eq= new Equipo(nombres);
        try { 
   ...
   @Test
    public void deberiaLanzarExcepcionSiNoSePuedeCalcularElValorEstimado2(){
        String [] nombres={"Pedro","Santiago","Marcos","Ospina","Juan"};
        Equipo eq= new Equipo(nombres);
        try { 
           assertEquals(25000,eq.valorHoraEstimado());
        } catch (EquipoExcepcion e) {
            fail("Lanzó excepcion");
        }    
    }
